...
Follow the instructions at :ref:`Installing VPP Binaries <installing-VPP-binaries>` for installing xenial vpp packages from the release repo.  Please note, certain aspects of this tutorial require vpp 17.10 or later.
